...
<div class="wrapper">
    <form class="nice-form" method="get">    <!---PHP--->
        ...
        <input formaction="/back/LogInS.php" id="name" name = "userName" type="text" placeholder="Name" class="checked">
        <input formaction="/back/LogInS.php" id="password" class="checked" name = "userPassword" placeholder="Password" type="password">
        <input formaction="/back/LogInS.php" type="submit" value="SUBMIT" name="send" disabled class="check-button">
    </form>
</div>
